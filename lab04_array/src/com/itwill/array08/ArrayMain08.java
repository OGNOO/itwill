...
public class ArrayMain08 {
	...
	public static void main(String[] args) {
		...
		int arrary2[][] = new int[3][]; // 1차원 배열 3개를 원소로 갖는 2차원 배열

		// 열의 개수가 미정인 2차원 배열은 사용하기 전에 반드시 1차원 배열들을 각각 생성해야만 함
		arrary2[0] = new int[2]; // 원소 2개를 갖는 1차원 배열
		arrary2[1] = new int[4]; // 원소 4개를 갖는 1차원 배열
		arrary2[2] = new int[3]; // 원소 3개를 갖는 1차원 배열
