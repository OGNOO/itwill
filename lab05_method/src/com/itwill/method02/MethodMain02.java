...
public class MethodMain02 {
	...
	public static void main(String[] args) {
		...
		double i = random.nextFloat(100);
		double j = random.nextFloat(100);

		double add = add(i, j); // add 메서드 호출
		double subtract = subtract(i, j); // subtract 메서드 호출
		double multiply = multiply(i, j); // multiply 메서드 호출
		double divide = divide(i, j); // divide 메서드 호출
