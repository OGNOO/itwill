...
/**
 * 은행 계좌 정보. 속성: 계좌 번호(int), 잔고(int). 기능: 입금, 출금, 이체, 정보 출력
 * 
 */
public class Account {
	...
	/**
	 * transfer(이체). 내 계좌에서의 잔고에서는 이체금액 amount 를 빼고, 이체할 계좌 to 의 잔고에서는 amount 를 더함
	 * 
	...
	public void info() {
		...
		System.out.println("계좌 정보: " + accountNo);
