 ...
 * 필드들을 private 로 선언해서 클래스 외부에서는 보이지 않도록(직접 접근할 수 없도록) 감추고,
 * 대신에 필요한 경우에 한해서 public 으로 공개한 메서드를 제공해서
...
public class ModifierMain03 {
	public static void main(String[] args) {
		...
		Person person = new Person("오쌤", 100);
		System.out.println("이름: " + person.getName());
		System.out.println("나이(변경전): " + person.getAge());
		person.setAge(50);
		System.out.println("나이(변경후): " + person.getAge());
	}
