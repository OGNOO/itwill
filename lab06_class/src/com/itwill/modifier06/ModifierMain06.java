 ...
 * 
 * final 수식어
 * - 클래스, 클래스 멤버(필드, 메서드), 지역 변수에서 사용 가능
 * - final 의미: 바꿀 수 없는
...
public class ModifierMain06 {
	...
	private final String message; // 선언할 때 초기화되지 않은 필드
...
//		app.message = ""; // -> 필드는 객체 생성 이후에 값을 변경할 수 없음
		...
		// Test 클래스의 인스턴스(static 이 아닌) 멤버 사용: 먼저 객체를 생성해야 됨
		Test test = new Test();
