...
public class ListMain01 {
	...
	public static void main(String[] args) {
		// 정수들을 저장하는 ArrayList 를 생성
		ArrayList<Integer> numbers = new ArrayList<Integer>(); // new ArrayLis<Integer>();
		// -> 생성자 호출에서는 ArrayList 의 원소 타입을 생략할 수 있음

		// ArrayList 에 저장된 원소 개수
		...
		// ArrayList 수정(index, 값)
		numbers.set(0, Integer.valueOf(-10));
		System.out.println(numbers);
