	...
	public static void main(String[] args) {
		...
		try {
			...
			while (true) {
				...
				if (read == -1) { // 파일 끝(End-Of_File)
					break;
				}
				out.write(read); // 파일에서 1바이트 씀
